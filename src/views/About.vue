<template>
  <div class="about">
    <div class="container inner">
      <div class="row">
        <div class="col-lg-3 inner-right-md inner-bottom-sm">
          <!-- ============================================================= SIDE NAVIGATION ============================================================= -->
        ...
        <div class="col-lg-9 inner-left-md border-left">
          <!-- ============================================================= SECTION – HERO ============================================================= -->
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <p>
                  ...
                  interaction. Humans evolved as a social species. And while some of us prefer less company, no one can
                  do it all alone.
                </p>
                <p>
                  This site isn't about pretty pictures. It's a place where you can build a safe community and share
